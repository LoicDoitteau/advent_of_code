...
fs.readFile("./2019/day_9/input.txt", 'utf8', (err, data) => {
    ...
    const instructions = {
        "01" : parametersMode => {
            const value1 = modes.read[parametersMode[2]](intcode[pointer + 1] || 0, relativeBase);
            const value2 = modes.read[parametersMode[1]](intcode[pointer + 2] || 0, relativeBase);
            const value3 = modes.write[parametersMode[0]](intcode[pointer + 3] || 0, relativeBase);
        ...
        "03" : parametersMode => {
            const value1 = modes.write[parametersMode[2]](intcode[pointer + 1] || 0, relativeBase);
